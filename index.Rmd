...
_note:_ The goal was to make this page interactive, and let the user select which feature to show on this page. This worked, but took very long computationally, which is why it was decided to just place all histograms in picture format next to each other on this page. 
