...
### **Acousticness** - Are winter songs typically more acoustic than summer songs?
...
ggplot(seasons, aes(x=acousticness, color=Category, fill=Category)) + geom_histogram(binwidth=0.1, position="identity", alpha=0.5) + labs(title="Acousticness in tracks", x="Acousticness", y="Count") + theme(plot.title = element_text(hjust = 0.5))

```

---------------------------------------

**Acousticness of the playlists**
